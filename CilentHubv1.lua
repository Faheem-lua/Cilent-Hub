-- Cilent Hub v1 - Key System + Full Hub Integration
...
local KeyWindow = Fluent:CreateWindow({
    Title = "Cilent Hub v1 | Steal A Brainrot",
    SubTitle = "Authecation | Keysystem v1",
    TabWidth = 160,
...
KeyTab:AddButton({
    ...
    Callback = function()
        if setclipboard then
            setclipboard("https://pastefy.app/b6AU8ZpZ/raw")
            Fluent:Notify({
                Title = "Link Copied!",
...
local Window = Fluent:CreateWindow({
    Title = "STEAL A BRAINROT 〢 Cilent Hub v1",
...
task.spawn(function()
    ...
    -- 👇 Credits - Faheem _ Main k4sii Adjusting Chatgpt helping some callback function code :) )
    -- Made by Faheem X K4sii (Arab Freinds east west..
end
